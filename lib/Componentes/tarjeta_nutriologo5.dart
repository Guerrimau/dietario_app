...
class TarjetaNutriologo5 extends StatelessWidget {
  String foto = "assets/images/nutriologo5.jpeg";
  String nombre;
  String especialidad;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          fotografia,
          Expanded( 
            child: Center(child: Text("Call me babe please\n Te nutro completo",textAlign: 
